...
% [ ] Marks will be awarded for descriptions of design decisions that correctly use and reference concepts taught in class and in readings.
...
% Identify tasks that are most important to do most often - should dominate interface
% Make important information prevalent
% Hue, position, contrast, typography, images and size
% Structure
% - Hierarchy, alignment of edges and margins (e.g., Grid layout)
% - Grouping - through similarity and proximity
% - Relationships - symbols and colours of controls
